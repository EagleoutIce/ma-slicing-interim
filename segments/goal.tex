...
\begin{frame}[c]{Requirements}%  on other slicing algorithms
...
\end{onlyenv}
   \item<5-> Slicing algorithm \onslide<20-|handout:5->{\After{algorithm}}\begin{onlyenv}<18-19|handout:4>
      \begin{itemize}
      \item<18-> Basic slicing algorithm by \citeauthor{weiser_program_1984}\textsuperscript{\color{gray}\cite{weiser_program_1984}}% TODO:  inter-procedural
...
\item TODO: other Slicers like JavaSlicer, Slicer4J, Slicer Generators wie Espresso (Java), AdaSlicer, Formals: Chisel...
\item TODO: DFlow Data Flow C/C++
}(1)%
\end{frame}
